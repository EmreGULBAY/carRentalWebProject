...
<body>
<div class="navbar">
    <a class="fa fa-home" onclick="closeAll()" href="adminPage.php"
...
<div id="Profile" onclick="closeProfile()">
    ...
    <form>
        <div class="row">
            <input class="but" type="submit" value="Rents" formaction="adminUserRents.php" style="position: absolute;top:35%;font-size:1vw;">
        </div>
        <div class="row">
